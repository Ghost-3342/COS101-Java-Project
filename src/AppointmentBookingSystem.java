...
public class AppointmentBookingSystem {
    ...
    private void bookAppointment() {
        ...
        // Validation
        if (fullName.isEmpty() || bookingName.isEmpty() || email.isEmpty() || selectedDate == null) {
        ...
        if (paymentMethod.equals("Online")) {
            if (cardName.isEmpty() || cardNumber.isEmpty() || expirationDate.isEmpty() || cvv.isEmpty()) {
                JOptionPane.showMessageDialog(frame, "Please fill in all payment details for online payment.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(frame, "Invalid card number or CVV.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void writeBookingToFile(String bookingInfo) {
        try (FileWriter writer = new FileWriter("bookings.txt", true)) {
            ...
            JOptionPane.showMessageDialog(frame, "Failed to write booking to file.", "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
